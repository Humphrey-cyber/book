...
class Book(models.Model):
    ...
    description = models.TextField()  # Short description of the book
    price = models.DecimalField(max_digits=6, decimal_places=2)  # Price of the book
    cover_image = models.ImageField(upload_to='book_covers/', blank=True, null=True)  # Optional cover image

    def __str__(self):
        return self.title  # Display the book title as its string representation
